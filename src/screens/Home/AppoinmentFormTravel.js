...
const AppoinmentFormTravel = ({navigation}) => {
  return (
    <View style={commonStyles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.form}>
          ...
          />
          <Text style={styles.small}>
            In the case of a child, please enter the parent’s mobile number
          </Text>
          {/* Email Address */}
          <Text style={[styles.form_text, {marginTop: 20}]}>
            Email {''} address*
          ...
          <TouchableOpacity activeOpacity={0.8} style={styles.idCard}>
            <Text style={styles.idCard_text}>
              I don't have a national identity number
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
           activeOpacity={0.8}
           onPress={()=> navigation.navigate('AppoinmentFormTravel')}
...
export default AppoinmentFormTravel
